<template lang="html">
  <div id="content">
    <div class="clearfix try_it try_it_text_side_space">
      <img src="static/img/box.png" alt="hurry up try it" />
      <div id="try_it_text">
        <h1>IDEAS?</h1>
...
#try_it_button {
    ...
    color: #FFF;
    font-size: 25px;
    background-image: linear-gradient(#FFBA53 50%, #F99303 50%);
    border-radius: 6px;
    border-style: none;
    height: 59px;
    width: inherit;
...
#content_try_it_content_button {
    margin: 0 auto;
    width: 300px;
}

.content_text_side_space {
    margin: 151px auto;
    width: 820px;
}

.content_text_side_space p {
    font-size: 17px;
}
